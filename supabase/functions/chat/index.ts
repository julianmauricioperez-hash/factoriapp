    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: "system", 
            content: "Eres un asistente de IA amigable y útil. Respondes siempre en español de forma clara y concisa. Ayudas a los usuarios a probar y mejorar sus prompts." 
          },
          ...messages,
        ],
        stream: true,
